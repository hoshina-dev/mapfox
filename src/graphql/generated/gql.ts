 ...
 */
export function graphql(
  source: "query ChildrenByCode($parentCode: String!, $childLevel: Int!) {\n  childrenByCode(parentCode: $parentCode, childLevel: $childLevel) {\n    id\n    name\n    isoCode\n    geometry\n    adminLevel\n    parentCode\n  }\n}",
): (typeof documents)["query ChildrenByCode($parentCode: String!, $childLevel: Int!) {\n  childrenByCode(parentCode: $parentCode, childLevel: $childLevel) {\n    id\n    name\n    isoCode\n    geometry\n    adminLevel\n    parentCode\n  }\n}"];
